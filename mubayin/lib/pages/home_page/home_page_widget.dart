                          ...
                          child: Container(
                            ...
                            child: Builder(
                              builder: (context) => InkWell(
                                ...
                                onTap: () async {
                                  if (((currentUserDocument?.history
                                                  .toList() ??
                                              [])
                                          .isNotEmpty) ==
                                      false) {
                                                                      ...
                                                                      child: StreamBuilder<
                                                                        ...
                                                                        stream:
                                                                          ...
                                                                          queryBuilder: (contactsRecord) =>
                                                                            ...
                                                                            Filter(
                                                                              'cid',
                                                                              isEqualTo: listViewHistoryRecord.callerId,
                                                                            ),
                                                                            Filter(
                                                                              'cid',
                                                                              isEqualTo: listViewHistoryRecord.receiverId,
                                                                            ),
                                                                          )),
                                                                          singleRecord:
                                                                              true,
                                                                        ...
                                                                        builder:
                                                                          ...
                                                                          return Text(
                                                                            valueOrDefault<String>(
                                                                              () {
                                                                                if (listViewHistoryRecord.callerId != currentUserReference) {
                                                                                  return textContactsRecord?.contactName;
                                                                                } else if (listViewHistoryRecord.receiverId != currentUserReference) {
                                                                                  return textContactsRecord?.contactName;
                                                                                } else {
                                                                                  return 'Error';
                                                                                }
                                                                        ...
                                                                        children: [
                                                                          Align(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              padding: const EdgeInsetsDirectional.fromSTEB(0.0, 0.0, 20.0, 0.0),
                                                                              child: Text(
                                                                                dateTimeFormat("d/M h:mm a", listViewHistoryRecord.dateTime!),
                                                                          ...
                                                                          Align(
                                                                            ...
                                                                            child:
                                                                                Text(
                                                                              listViewHistoryRecord.duration,
                                                                              textAlign: TextAlign.start,
                                                                              style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                    fontFamily: 'Manrope',
                                                                                    color: FlutterFlowTheme.of(context).eerieBlack,
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    child: Icon(
                                                                      ...
                                                                      color: valueOrDefault<
                                                                          Color>(
                                                                        listViewHistoryRecord.callStatus ==
                                                                                'Taken'
